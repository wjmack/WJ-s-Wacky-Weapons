...
public class RocketBoots extends ArmorItem {
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(new TranslatableText("item.wjsweapons.rb_subtext_1").formatted(Formatting.GRAY));
        tooltip.add(new TranslatableText("item.wjsweapons.rb_subtext_2").formatted(Formatting.GRAY));
    }
}